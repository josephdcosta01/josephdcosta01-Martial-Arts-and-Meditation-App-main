...
class _FilterState extends State<Filter> {
  ...
  List<String> filters=['Marks','Most Recents','By Prices,From Lowest to Highest','By Price From Highest to Lowest'];
       ...
       padding: EdgeInsets.all(20),
        child: Container(
          ...
          children: [
            ...
            SizedBox(height: 15,),
            Text('300+ Courses',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
            SizedBox(height: 20,),
       ...
       Positioned(
         ...
         color: Colors.white,
             child: Row(
               ...
               children: [
                 Text('Reset',style: TextStyle(fontSize: 18,color: Colors.blueAccent.shade700),),
                 _buildDivider(),
                 Text('Apply',style: TextStyle(fontSize: 18,color: Colors.blueAccent.shade700))
               ],
             ),
